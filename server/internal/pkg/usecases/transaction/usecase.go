...
func (u *TransactionUsecase) UpdateTransaction(ctx context.Context, transactionId int, dto dto.TransactionRequestDTO) error {
	return u.repository.UpdateTransaction(ctx, transactionId, dto.Name, dto.Amount, dto.CategoryId, dto.Description, dto.TransactionDateTime)
}
